...
function displayitems() {
    ...
    for (let index of blankArray) {
        document.getElementById('CartItems').innerHTML += `
        <div class="col-lg-2 col-md-2 mt-2" style="text-align: center;" id = "${index.id}">
                    <img class="mx-auto" src="${index.image}" alt="Image" height="100px" style="object-fit: contain;">
                </div>
                ...
                <div class="col-lg-1 col-md-1 my-auto" style="text-align: center;">
                    <p><input id="number"  min="1"  type="number"/></p>
                </div>
